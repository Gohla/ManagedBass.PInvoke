...
{
    /// <summary>
    /// User defined Window Message Process Handler (to be used with <see cref="BassWaDsp.Load" />).
    /// <para>
    ...
    /// </para>
    /// </summary>
    /// <param name="hwnd">The Window handle we are dealing with - which is the hidden fake window which BASS_WADSP has created during <see cref="BassWaDsp.Load" /> and which emulates a Winamp 1.x class.</param>
