...
namespace ManagedBass.Vst
{
	...
	public static class BassVst
	{
        ...
        public static BassVstParamInfo GetParamInfo(int VstHandle, int ParamIndex)
		{
		    ...
		    if (!GetParamInfo(VstHandle, ParamIndex, out info))
                throw new BassException();
		...
		public static extern bool ProcessEvent(int VstHandle, int MidiChannel, MidiEventType EventType, int Param);
